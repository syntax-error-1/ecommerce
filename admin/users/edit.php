...
if(!empty($userpassword)){
	...
	$sql = "UPDATE customer SET name='$firstname',surname='$lastname',email='$useremail',contact_info='$usercontactnumber',address='$useraddress' WHERE id='$id'";
}
...
<?php 
$id = $_GET["id"];
$query = "SELECT id,name,surname,email,address,contact_info FROM customer WHERE id='$id'";
