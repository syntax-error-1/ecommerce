...
if(isset($_POST["submitbutton"])){
	...
	$sql = "UPDATE products SET name='$product_name',stock='$stock',description='$description' WHERE product_id='$id'";
...
<?php 
$id = $_GET["id"];
$query = "SELECT product_id,name,description,price,stock FROM products WHERE product_id='$id'";
